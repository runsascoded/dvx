...
from dvx.ignore import DvcIgnoreFilter
from dvx.log import logger
from dvx.utils.objects import cached_property
...
if TYPE_CHECKING:
    ...
    from dvx.lock import LockBase
    from dvx.output import Output
    from dvx.scm import Git, NoSCM
...
class Repo:
    ...
    from dvx.repo.add import add  # type: ignore[misc]
    from dvx.repo.checkout import checkout  # type: ignore[misc]
    from dvx.repo.commit import commit  # type: ignore[misc]
    from dvx.repo.destroy import destroy  # type: ignore[misc]
    from dvx.repo.diff import diff  # type: ignore[misc]
    from dvx.repo.du import du as _du  # type: ignore[misc]
    from dvx.repo.fetch import fetch  # type: ignore[misc]
    from dvx.repo.gc import gc  # type: ignore[misc]
    from dvx.repo.get import get as _get  # type: ignore[misc]
    from dvx.repo.get_url import get_url as _get_url  # type: ignore[misc]
    from dvx.repo.imp import imp  # type: ignore[misc]
    from dvx.repo.imp_db import imp_db  # type: ignore[misc]
    from dvx.repo.imp_url import imp_url  # type: ignore[misc]
    from dvx.repo.install import install  # type: ignore[misc]
    from dvx.repo.ls import ls as _ls  # type: ignore[misc]
    from dvx.repo.ls_url import ls_url as _ls_url  # type: ignore[misc]
    from dvx.repo.move import move  # type: ignore[misc]
    from dvx.repo.pull import pull  # type: ignore[misc]
    from dvx.repo.push import push  # type: ignore[misc]
    from dvx.repo.remove import remove  # type: ignore[misc]
    from dvx.repo.status import status  # type: ignore[misc]
    from dvx.repo.update import update  # type: ignore[misc]
    ...
    def __init__(  # noqa: PLR0915
        ...
        from dvx.cachemgr import CacheManager
        from dvx.data_cloud import DataCloud
        from dvx.fs import GitFileSystem, LocalFileSystem
        from dvx.lock import LockNoop, make_lock
        from dvx.repo.stage import StageLoad
        from dvx.scm import SCM
        from dvx.stage.cache import StageCache
    ...
    def index(self) -> "Index":
        from dvx.repo.index import Index
    ...
    def scm_context(self) -> "SCMContext":
        from dvx.repo.scm_context import SCMContext
    ...
    def get_rev(self):
        ...
        assert self.scm
        if isinstance(self.fs, LocalFileSystem):
            from dvx.scm import map_scm_exception
    ...
    def find_root(cls, root=None, fs=None) -> str:
        from dvx.fs import LocalFileSystem, localfs
    ...
    def init(root_dir=os.curdir, no_scm=False, force=False, subdir=False) -> "Repo":
        from dvx.repo.init import init
    ...
    def brancher(self, *args, **kwargs):
        from dvx.repo.brancher import brancher
    ...
    def site_cache_dir(self) -> str:
        ...
        from dvx.dirs import site_cache_dir
        from dvx.fs import GitFileSystem
        from dvx.version import version_tuple
