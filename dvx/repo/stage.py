...
from dvx.repo import lock_repo
from dvx.ui import ui
from dvx.utils import as_posix, parse_target
...
if typing.TYPE_CHECKING:
    ...
    from dvx.stage import PipelineStage, Stage
    from dvx.stage.loader import StageLoader
...
def _collect_with_deps(stages: StageList, graph: "DiGraph") -> StageSet:
    from dvx.exceptions import StageNotFoundError
    from dvx.repo.graph import collect_pipeline
...
def _maybe_collect_from_dvc_yaml(
    ...
    from dvx.stage.exceptions import StageNotFound
...
class StageLoad:
    ...
    def create(
        ...
        **stage_data,
        ...
        """
        from dvx.stage import PipelineStage, Stage, create_stage, restore_fields
        from dvx.stage.exceptions import InvalidStageName
        from dvx.stage.utils import is_valid_name, prepare_file_path, validate_kwargs
        ...
        if validate:
            if not force:
                from dvx.stage.utils import check_stage_exists
    ...
    def load_all(
        ...
        from dvx.stage.loader import SingleStageLoader, StageLoader
    ...
    def collect(
        ...
        if recursive and self.fs.isdir(target):
            from dvx.repo.graph import collect_inside_path
