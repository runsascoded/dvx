...
from dvx.stage import serialize
...
from dvx.utils.collections import apply_diff
from dvx.utils.objects import cached_property
from dvx.utils.serialize import dump_yaml, modify_yaml

if TYPE_CHECKING:
    from dvx.repo import Repo
    from dvx.types import StrOrBytesPath
...
def is_git_ignored(repo, path):
    ...
    from dvx.scm import NoSCMError
...
class FileMixin:
    ...
    def _load_yaml(self, **kwargs: Any) -> tuple[Any, str]:
        from dvx.utils import strictyaml
...
class SingleStageFile(FileMixin):
    from dvx.schema import COMPILED_SINGLE_STAGE_SCHEMA as SCHEMA
    from dvx.stage.loader import SingleStageLoader as LOADER  # noqa: N814
...
class ProjectFile(FileMixin):
    ...
    from dvx.schema import COMPILED_MULTI_STAGE_SCHEMA as SCHEMA
    from dvx.stage.loader import StageLoader as LOADER  # noqa: N814
...
class Lockfile(FileMixin):
    from dvx.schema import COMPILED_LOCKFILE_SCHEMA as SCHEMA
