...
from dvx.cli.utils import DictAction, append_doc_link
from dvx.commands.ls.ls_colors import LsColors
...
def _format_entry(entry, name, with_size=True, with_hash=False):
    from dvx.utils.humanize import naturalsize
...
class CmdList(CmdBaseNoRepo):
    def _show_tree(self):
        from dvx.repo.ls import ls_tree
