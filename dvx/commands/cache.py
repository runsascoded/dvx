...
from dvx.commands.config import CmdConfig
...
class CmdCacheMigrate(CmdBase):
    def run(self):
        from dvx.cachemgr import migrate_2_to_3
        from dvx.repo.commit import commit_2_to_3
...
def add_parser(subparsers, parent_parser):
    from dvx.commands.config import parent_config_parser
