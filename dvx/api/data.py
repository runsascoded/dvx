...
from dvx.exceptions import FileMissingError, OutputNotFoundError, PathMissingError
...
def _wrap_exceptions(repo, url):
    ...
    from dvx.exceptions import NoOutputInExternalRepoError, NoRemoteInExternalRepoError
