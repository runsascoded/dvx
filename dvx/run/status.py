...
Usage:
    status_db = ArtifactStatusDB()  # uses .dvc/dvx.db by default
...
class ArtifactStatusDB:
    ...
    def __init__(self, db_path: Path | None = None):
        ...
        Args:
            db_path: Path to SQLite database. Defaults to .dvc/dvx.db
...
def get_artifact_hash_cached(
    ...
    # Update cache
    db.set(path_str, mtime=current_mtime, hash=hash_value, size=current_size)
