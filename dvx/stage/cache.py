...
from dvx import fs
from dvx.config import RemoteConfigError
from dvx.exceptions import CollectCacheError, DvcException
from dvx.log import logger
from dvx.utils import dict_sha256, relpath
...
class StageCache:
    ...
    def _load_cache(self, key, value):
        ...
        from dvx.schema import COMPILED_LOCK_FILE_STAGE_SCHEMA
        from dvx.utils.serialize import YAMLFileCorruptedError, load_yaml
    ...
    def save(self, stage):
        ...
        from dvx.schema import COMPILED_LOCK_FILE_STAGE_SCHEMA
        from dvx.utils.serialize import dump_yaml
    ...
    def transfer(self, from_odb, to_odb, force=True):
        from dvx.fs import HTTPFileSystem, LocalFileSystem
