...
from dvx.output import Annotation, Output
from dvx.utils.collections import apply_diff
from dvx.utils.serialize import parse_yaml_for_update
...
def to_single_stage_lockfile(stage: "Stage", **kwargs) -> dict:
    ...
    from dvx.dependency import DatasetDependency
    from dvx.output import (
