...
from dvx import prompt
from dvx.exceptions import CacheLinkError, CheckoutError, DvcException, MergeError
...
if TYPE_CHECKING:
    from dvx.dependency import Dependency, ParamsDependency
    from dvx.dvcfile import ProjectFile, SingleStageFile
    from dvx.output import Output
    from dvx.repo import Repo
    from dvx.types import StrPath
...
def create_stage(cls: type[_T], repo, path, **kwargs) -> _T:
    from dvx.dvcfile import check_dvcfile_path
...
class Stage(params.StageParams):
    ...
    def dvcfile(self) -> Union["ProjectFile", "SingleStageFile"]:
        ...
        from dvx.dvcfile import load_file
    ...
    def params(self) -> list["ParamsDependency"]:
        from dvx.dependency import ParamsDependency
    ...
    def is_repo_import(self) -> bool:
        ...
        from dvx.dependency import RepoDependency
    ...
    def is_db_import(self) -> bool:
        ...
        from dvx.dependency import DbDependency
    ...
    def save_deps(self, allow_missing=False):
        from dvx.dependency.base import DependencyDoesNotExistError
    ...
    def save_outs(self, allow_missing: bool = False):
        from dvx.output import OutputDoesNotExistError
...
class PipelineStage(Stage):
    ...
    @property
    def addressing(self):
        from dvx.dvcfile import PROJECT_FILE
    ...
    def reload(self) -> Stage:
        from dvx.dvcfile import ProjectFile
