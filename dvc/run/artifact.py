...
Example usage:
    from dvc.run.artifact import Artifact, Computation
...
from dvc.run.dvc_files import (
    get_git_head_sha,
    read_dvc_file,
    write_dvc_file,
)
from dvc.run.hash import compute_file_size, compute_md5
...
def materialize(
    ...
    """
    from dvc.run.dvc_files import is_output_fresh
